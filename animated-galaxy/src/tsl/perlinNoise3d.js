...
export const perlinNoise3d = tslFn(([ P_immutable ]) => {
    const Pi0 = vec3(P_immutable.floor())
    const Pi1 = Pi0.add(vec3(1))
    const Pf0 = fract(P_immutable)
